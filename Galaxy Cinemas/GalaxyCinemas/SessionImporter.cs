            ...
            try
            {
                ...
                foreach (string line in lines)
                {
                    ...
                    try
                    {
                        ...
                        // Checking cinema number if it is a number
                        byte cinemaNumber;
                        ...
                        // Checking cinema number if it's valid
                        if(!(cinemaNumber >= 1) )
                        {
                            results.FailedRows++;
                            results.ErrorMessages.Add(string.Format("Line {0}: Cinema Number must be positive.", lineNum));
                            continue;
                        }
